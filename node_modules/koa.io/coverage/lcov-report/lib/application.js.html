...
<html lang="en">
<head>
    <title>Code coverage report for lib/application.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/application.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">lib/</a> &#187; application.js</div>
</div>
<div class="body">
...
&nbsp;
  ...
  this.use(session);
&nbsp;
  var namespace = opts.namespace || <span class="branch-1 cbranch-no" title="branch not covered" >['/'];</span>
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!Array.isArray(namespace)) {
    namespace = [namespace];
  }
&nbsp;
  var self = this;
